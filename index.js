...
//     const userData = req.body; // Data sent from your React form

//     // --- SERVER-SIDE VALIDATION FOR PHONE NUMBER AND OTHER FIELDS ---
//     const { name, facebookLink, phone, status, reason } = userData;

//     // Basic validation: Check if required fields exist
//     if (!name || !facebookLink || !phone || !status || !reason) {
...
//     // Data to save (using validated fields)
//     const dataToSave = {
//       name,
//       facebookLink,
//       phone,
...
//     if (!db) {
//         // console.error('DELETE Error: Database not connected.'); // Removed log
//         return res.status(500).json({ message: 'Database not connected.' });
//     }

//     const id = req.params.id;
//     // console.log('Received ID for deletion:', id); // Removed log

//     if (!ObjectId.isValid(id)) {
//         // console.error('DELETE Error: Invalid ID format received:', id); // Removed log
...
//         // console.log('MongoDB Delete Query:', JSON.stringify(query)); // Removed log

//         const result = await userReportsCollection.deleteOne(query);

//         if (result.deletedCount === 1) {
//             // console.log(`Successfully deleted user report with ID: ${id}`); // Removed log
//             res.status(200).json({ message: 'User report deleted successfully.' });
//         } else {
//             // console.warn(`User report with ID: ${id} not found for deletion.`); // Removed log
//             res.status(404).json({ message: 'User report not found.' });
//         }
//     } catch (error) {
//         console.error('Error deleting user report:', error); // Keep this for actual errors
